...
class VectorQuantifier @Inject constructor() : Quantifier {
    ...
    private val cP: List<Double> = listOf(18030.5, 79784.81428571, 49310.8, 23184.71428571, 48329.74285714)
    private val cQ: List<Double> = listOf(11514.61428571, 58630.32857143, 35774.17142857, 38538.14285714, 41632.17142857)
    private val cR: List<Double> = listOf(19672.75714286, 80149.45714286, 24773.82857143, 25874.1, 53644.62857143)
    ...
    private val cX: List<Double> = listOf(18458.95714286, 82259.44285714, 49680.01428571, 41380.05714286, 53511.54285714)
    private val cY: List<Double> = listOf(9470.66857143, 81764.34285714, 48615.35714286, 57266.58571429, 32105.25714286)
